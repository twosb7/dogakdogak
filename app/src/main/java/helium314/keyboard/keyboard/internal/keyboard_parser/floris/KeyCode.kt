...
object KeyCode {
    ...
    const val KEYBOARD_SIZE_DECREASE =   -10050
    const val KEYBOARD_SIZE_INCREASE =   -10052
    const val CHEONJIIN_PUNCT_MAIN =     -10053
    const val CHEONJIIN_PUNCT_NUMPAD =   -10054
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        SEND_INTENT_THREE, INLINE_EMOJI_SEARCH_DONE, META_LOCK, KEYBOARD_SIZE_DECREASE, KEYBOARD_SIZE_INCREASE,
        CHEONJIIN_PUNCT_MAIN, CHEONJIIN_PUNCT_NUMPAD
        -> this
